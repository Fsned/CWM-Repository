...
/*
	The following arrays contain strings checked by the UART task, and the corresponding functions called, respectively.
	Example: user entering "ADC" in the UART, will call the corresponding function nADC_Status(); (Index field 12).
*/
